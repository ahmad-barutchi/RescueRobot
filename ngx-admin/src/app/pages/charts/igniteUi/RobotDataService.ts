...
export class RobotDataService {
  ...
  public getData(): any[] {
    return [
      { time: new Date(2013, 1, 1, 5, 13, 59), open: 268.93, high: 268.93, low: 262.80, close: 265.00, volume: 6118146 },
  ...
  public getDatas(): any[] {
    ...
    console.log('temp: ', data[0]['temp']);
    this.result = [
      { time: new Date(data[0]['year'], data[0]['month'], data[0]['date']), open: 65, high: 268.93, low: 262.80, close: 75, volume: 6118146 },
      { time: new Date(2013, 1, 4), open: 262.78, high: 264.68, low: 259.07, close: 259.98, volume: 3723793 },
      { time: new Date(2013, 1, 5), open: 262.00, high: 268.03, low: 261.46, close: 266.89, volume: 4013780 },
      { time: new Date(2013, 1, 6), open: 265.16, high: 266.89, low: 261.11, close: 262.22, volume: 2772204 },
      { time: new Date(2013, 1, 7), open: 264.10, high: 264.10, low: 255.11, close: 260.23, volume: 3977065 },
